...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            WHEN p.id_categoria = 1 THEN 'Electrónica'
            WHEN p.id_categoria = 2 THEN 'Ropa'
            WHEN p.id_categoria = 3 THEN 'Alimentos'
            WHEN p.id_categoria = 4 THEN 'Libros'
            WHEN p.id_categoria = 5 THEN 'Accesorios'
            ELSE 'Sin Categoría'
        END AS Categoria,
