...
namespace CapaNegocio
{
    public class DetalleVentaBLL
    {
        ...
        {
            return detalleDAL.ObtenerDetalleVentaConJoins();
        }
    }

    // Compatibility wrapper: many forms reference `DetalleVentaBL` (single "L").
    // Provide a thin subclass that exposes the same API via inheritance.
    public class DetalleVentaBL : DetalleVentaBLL
    {
    }
}